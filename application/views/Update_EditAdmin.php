  ...
  <body>
    <div class="container-fluid">
      <div class="col-lg-6 col-lg-offset-3 col-sm-6 col-sm-offset-3"><br>
        <h1 align="center">FORM UPDATE ADMIN</h1><br>
        <div class="thumbnail">
        <form action="<?php echo base_url()."Welcome/do_updateAdmin"; ?>" method="post" enctype="multipart/form-data">

          <div class="form-group form-group-lg has-feedback">
          <input type="hidden" name="idd" id="idd" class="form-control textbox" value="<?php echo $id ?>">
          </div>

          <div class="form-group form-group-lg has-feedback">
          <label for="nama">Name</label>
          <input type="text" name="namaa" id="namaa" class="form-control textbox" value="<?php echo $nama ?>">
          </div>

          <div class="form-group form-group-lg has-feedback">
          <label for="user">Username</label>
          <input type="text" name="username" id="username" class="form-control textbox" value="<?php echo $usrname ?>">
          </div>

          <div class="form-group form-group-lg has-feedback">
          <label for="pass">Password</label>
          <input type="password" name="password" id="password" class="form-control textbox" value="<?php echo $pw ?>">
          </div>

          <div class="form-group form-group-lg has-feedback">
          <label for="ttgl">Date of Birth</label>
          <input type="text" name="birth" id="birth" class="form-control textbox" value="<?php echo $lahir ?>">
          </div>
          ...
          <label for="pass">Gender</label><br>
            ...
            <h4><span class="label label-default">Old Selected <?php echo $Gender ?></span></h4>
          </div>

          <div class="form-group form-group-lg has-feedback">
            <label for="add">Address</label>
            <textarea class="form-control" rows="7" id="alamat" name="alamat"><?php echo $alamat ?></textarea>
          </div>

          <div class="form-group form-group-lg has-feedback">
          <label for="maili">Email</label>
          <input type="email" name="mail" id="mail" class="form-control textbox" value="<?php echo $email ?>">
          </div>
          ...
          </select><h4><span class="label label-default">Old Selected <?php echo $stt ?></span></h4>
          </div>
